...
<html>
    ...
    <head>
        ...
        <style>
            ...
            #restaurant_name,#restaurant_address,#food_name,#food_restaurant_address
            {
                color: white;
                font-family: 'Julius Sans One';
            }
    ...
    <body>
        ...
        <div id="restaurant_body" class="row">
            ...
            ?>
                ...
                <div align="center" id="image_body" class="col-md-3">
                    <a href="details_restaurant.php" style="text-decoration:none;">
                        <img id="restaurant_image" class="img-responsive" src="images/10.jpg">
            ...
            <div style="margin-bottom:5%;" class="row" align="center">
                <a href="restaurant.php" id="restaurant_view_more">View More</a>
            </div>
        </div>
        ...
        <div id="food_body" class="row">
            ...
            ?>
                ...
                <div align="center" id="image_body" class="col-md-3">
                    <a style="text-decoration:none;">
                        ...
                        <h4 id="food_restaurant_address">Price : BDT <?php echo $row['price'] ?></h4>
                    </a>
                </div>
            ...
            <div style="margin-bottom:5%;" class="row" align="center">
                <a href="foods.php" id="food_view_more">View More</a>
            </div>
        </div>
